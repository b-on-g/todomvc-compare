...
| -------------------- | --------------------------------------------- | -------------------------- | ------------------------- | ------------------------------- |
| **LOC логика + CSS** | 357 (134 .view.ts + 60 .view.tree + 163 .css) | 832 (502 логика + 330 CSS) | 566 (логика + CSS вместе) | 342 (логика, CSS в index.html)  |
| **LOC тесты**        | 140                                           | —                          | —                         | —                               |
| **LOC итого**        | 357 ( с тестами 497 )                         | 832                        | 566                       | 342                             |
